...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
        ...
        assignedCustomerPickupLocationRefListener = assignedCustomerPickupLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && !customerId.equals("")){
                    ...
                    pickupMarker = mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("Lokasi Jemput").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_jemput)));
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()) {
                    ...
                    if(map.get("destination")!=null){
                        ...
                        mCustomerDestination.setText("Tujuan: " + destination);
                    }
                    else{
                        mCustomerDestination.setText("Tujuan: --");
                    }
    ...
    private void endRide(){
        mRideStatus.setText("Pelanggan Diambil");
        erasePolylines();
        ...
        switch(requestCode){
            case LOCATION_REQUEST_CODE:{
                if(grantResults.length >0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(getApplicationContext(), "Mohon Beri Izin", Toast.LENGTH_LONG).show();
                }
                break;
            }
        }

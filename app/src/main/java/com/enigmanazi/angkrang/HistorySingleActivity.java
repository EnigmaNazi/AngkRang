...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        ...
        mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("Lokasi Jemput").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_jemput)));
        mMap.addMarker(new MarkerOptions().position(destinationLatLng).title("Tujuan"));
